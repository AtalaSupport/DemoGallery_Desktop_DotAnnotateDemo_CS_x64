...
namespace AtalaDemos.AboutBox
{
	...
	public class About : System.Windows.Forms.Form
	{
		...
		public About(string windowTitle, string progName)
		{
			...
			foreach (System.Reflection.AssemblyName name in refs)
			{
				...
				{
					case "atalasoft.dotimage":
					case "atalasoft.dotimage.wincontrols":
					case "atalasoft.dotannotate":
					case "atalasoft.dotimage.annotate":
					case "atalasoft.dotannotate.ink":
					case "atalasoft.dottwain":
					case "atalasoft.dotimage.pdfrasterizer":
					case "atalasoft.dotimage.barcodereader":
					case "atalasoft.dotimage.jpeg2000":
					case "atalasoft.dotimage.jbig2":
					case "atalasoft.dotimage.ocr":
					case "atalasoft.dotimage.extensions":
    ...
    "ge.  This is a good starting place for learning about the SDK.";
            ...
            this.demoGalleryLinkLabel.Text = "DotAnnotate Demo Home";
            ...
            // txtAssemblies
            // 
            this.txtAssemblies.BackColor = System.Drawing.SystemColors.Window;
